...
class Product
{
    ...
    $query = "INSERT INTO tbl_product(productName, catId, body, bid_start_from, image, publish_date, end_date_time, bank_name) 
    VALUES('$productName','$catId','$body','$bid_start_from','$uploaded_image','$publish_date','$end_date_time','$bankName')";
    $productinsert = $this->db->insert($query);
    $query2 = "insert into tbl_bid(productName,bid_start_from,name,email,phone,district,bid_data,bank_name) VALUES ('$productName','$bid_start_from','0','0',0,'0',0,'$bankName')";
