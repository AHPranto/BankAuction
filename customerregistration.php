...
<select name="bank_name" required="" class="form-control"> 
     ...
     <option value = "Southest Bank Ltd.">Southest Bank Ltd.</option>
       ...
       <option value = "AB Bank Ltd.">AB Bank Ltd.</option>
        <option value = "Prime Bank Ltd.">Prime Bank Ltd.</option>
         <option value = "Islami Bank Ltd.">Islami Bank Ltd.</option>
           <option value = "Al Arafah Bank Ltd.">Al Arafah Bank Ltd.</option>
             <option value = "Bank Asia Ltd.">Bank Asia Ltd.</option>
               <option value = "One Bank Ltd.">One Bank Ltd.</option>
                 <option value = "Standard Chattered Bank Ltd.">Standard Chattered Bank Ltd.</option>
                   <option value = "Estern Bank Ltd.">Estern Bank Ltd.</option>
                     <option value = "Modhumati Bank Ltd.">Modhumati Bank Ltd.</option>
   </select>

<br>
   <select name="branch_name" required="" class="form-control"> 
...
<br>
    <input type="text" placeholder="Enter Your Account Name" name="account_name" class="form-control" required="">
    <br>
    <input type="number" placeholder="Enter Your Account Number" name="account_number" class="form-control" required="">
<br>
<label>Note: This information is only for check your Bank balance statement</label>
...
$db = new Database();
   ...
   if(isset($_POST['submit'])){
       ...
       $res = $db->insert("insert into customerreg(name,gender,religion,phone,district,zipcode,address,nid_passport,occupation,anual_income,bank_name,branch_name,account_name,account_number,email,password) values('$name','$gender','$religion','$phone','$district', '$zipcode','$address','$nid_passport','$occupation','$anual_income','$bank_name','$branch_name','$account_name','$account_number','$email','$password')");
